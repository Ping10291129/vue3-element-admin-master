<template>
  <div class="login">
        ...
        <el-form-item prop="username">
          <div class="input-wrapper">
            ...
            <div class="input-container">
              ...
              <label
                for="username"
                :class="{ 'label-float': loginFormData.username || usernameFocus }"
              >
                {{ $t("login.username") }}
              </label>
            </div>
          ...
          <el-form-item prop="password">
            <div class="input-wrapper">
              ...
              <div class="input-container">
                ...
                <label
                  for="password"
                  :class="{ 'label-float': loginFormData.password || passwordFocus }"
                >
                  {{ $t("login.password") }}
                </label>
              </div>
        ...
        <el-form-item prop="captchaCode">
          <div class="input-wrapper">
            ...
            <div class="input-container">
              ...
              <label
                for="captchaCode"
                :class="{ 'label-float': loginFormData.captchaCode || captchaFocus }"
              >
                {{ $t("login.captchaCode") }}
              </label>
            </div>
    ...
    <div class="login-footer">
      <el-text size="small">
        Copyright © 2021 - 2025 zyx All Rights Reserved.
        <a href="http://beian.miit.gov.cn/" target="_blank">粤ICP备********号</a>
      </el-text>
    </div>
  </div>
</template>
